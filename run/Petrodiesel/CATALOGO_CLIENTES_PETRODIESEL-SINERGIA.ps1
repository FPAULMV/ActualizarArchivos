# Definir variables
        ...
        $ScriptPath = "C:\Users\Administrator\Sinergia\ServerDev - Server.53\Actualizar.Archivos\scrips\Petrodiesel"
        $ScriptName = "CATALOGO_CLIENTES_PETRODIESEL-SINERGIA.py"
